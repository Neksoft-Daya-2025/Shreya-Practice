...
<head>
    ...
    <title>@yield('title', 'Ligen Dealer Locator')</title>
                ...
                <div class="navbar-right-section">
                    <div class="contact-section">
                        ...
                        <div class="contact-details">
                            ...
                            <p class="hours">Mon - Sat: 09:00 am to 6:00 pm</p>
                        </div>
                    </div>
                    ...
                    <a href="https://ligenpower.com/" target="_blank" class="enquire-btn">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h5><i class="fas fa-store me-2"></i>Ligen Dealer Locator</h5>
                    <p class="mb-0">Find dealers and distributors near you across India.</p>
                </div>
                <div class="col-md-4 text-md-end">
                    <p class="mb-0">&copy; {{ date('Y') }} Ligen Dealer Locator. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
