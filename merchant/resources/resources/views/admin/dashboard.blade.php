...
@section('title', 'Admin Dashboard - Ligen Dealer Locator')
                        ...
                        <tbody>
                            @foreach($dealers as $dealer)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $dealer->status == 'active' ? 'success' : 'secondary' }}">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('admin.toggle-status', $dealer) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-{{ $dealer->status == 'active' ? 'warning' : 'success' }}" 
                                                    ...
                                                    <i class="fas fa-{{ $dealer->status == 'active' ? 'pause' : 'play' }}"></i>
                                                </button>
                                            </form>
